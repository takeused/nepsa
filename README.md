...
> **이어지는 개발은 다른 저장소에서 합니다.**
> 이 앱은 AHP 공동 평가 도구와 합쳐져 `takeused/decision-studio`로 옮겨졌습니다.
> 그쪽 저장소는 **비공개**라 권한이 없으면 열리지 않습니다. 접근이 필요하면 저장소 소유자에게 요청하세요.
>
> 이 저장소는 **2026-09-06 시점의 NEPSA 단독 앱**으로 남아 있습니다. 코드·문서·조사 기록은 그대로 유효하고
> MIT 라이선스도 그대로입니다. 다만 이후 변경은 여기에 반영되지 않습니다.
